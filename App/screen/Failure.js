...
<ScrollView keyboardShouldPersistTaps='handled'>
        ...
        <Text style={{textAlign:'center', color: Colors.dark_gray, fontSize:22, fontFamily: Fonts.bold}}>Failed</Text>

        <Text style={{textAlign:'center', color: Colors.dark_gray, fontSize:16, fontFamily: Fonts.regular}}>Your payment is failed. please try again.
</Text>
<Text style={{textAlign:'center', color: Colors.accent, fontSize:14, fontFamily: Fonts.light}}></Text>
